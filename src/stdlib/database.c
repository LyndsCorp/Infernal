                                                   ...
                                                   static int append_string(char **buffer, size_t *cap, size_t *len,
                                                       ...
                                                       *len += slen;
                                                       ...
                                                       return 0;
                                                                            ...
                                                                            /* Escapa y rodea con comillas una cadena. */
                                                                            static int append_quoted_string(char **buffer, size_t *cap, size_t *len,
                                                                                ...
                                                                                return append_char(buffer, cap, len, '"');
                                                                                                            ...
                                                                                                            /* Escribe una clave de mapa: sin comillas si es un identificador simple,
                                                                                                             * con comillas y escapes en caso contrario. */
                                                                                                            static int append_map_key(char **buffer, size_t *cap, size_t *len,
                                                                                                                                      const char *key) {
                                                                                                                if (!key) key = "";
                                                                                                                bool simple = (key[0] != '\0' && (isalpha((unsigned char)key[0]) || key[0] == '_'));
                                                                                                                if (simple) {
                                                                                                                ...
                                                                                                                return append_quoted_string(buffer, cap, len, key);
                                                                                                                                      ...
                                                                                                                                      /* force_inline: si es true, los mapas se escriben en una sola línea.
                                                                                                                                       * Los list siempre son inline. */
                                                                                                                                      static int value_to_text_rec(Value v, char **out, size_t *cap, size_t *len,
                                                                                                                                          ...
                                                                                                                                          switch (v.type) {
                                                                                                                                              ...
                                                                                                                                              case VAL_MAP: {
                                                                                                                                                  ...
                                                                                                                                                  /* Mapa vacío: se distingue del list vacío por el espacio interior. */
                                                                                                                                                  if (md->count == 0)
                                                                                                                                                      return append_string(out, cap, len, "[ ]");

                                                                                                                                                  if (force_inline) {
                                                                                                                                                      /* Mapa dentro de un list: forma inline. */
                                                                                                                                                      if (append_char(out, cap, len, '[') < 0) return -1;
                                                                                                                                          ...
                                                                                                                                          return -1;
                                                                                                                                                                   ...
                                                                                                                                                                   /* Salta espacios, tabuladores, saltos de línea y comentarios '#' hasta
                                                                                                                                                                   ...
                                                                                                                                                                   /* Devuelve true si, tras el '[', el contenido parece un mapa (hay un '='
                                                                                                                                                                    * fuera de strings y a profundidad 0 antes del cierre o una coma). */
                                                                                                                                                                   ...
                                                                                                                                                                   static char *parse_map_key(TextParser *p) {
                                                                                                                                                                       ...
                                                                                                                                                                       if (isalpha((unsigned char)c) || c == '_') {
                                                                                                                                                                           size_t start = p->pos;
                                                                                                                                                                           while (p->pos < p->len &&
                                                                                                                                                                               (isalnum((unsigned char)p->input[p->pos]) || p->input[p->pos] == '_'))
                                                                                                                                                                               p->pos++;
                                                                                                                                                                   ...
                                                                                                                                                                   static Value parse_value(TextParser *p, int depth) {
                                                                                                                                                                       ...
                                                                                                                                                                       if (c == '[') {
                                                                                                                                                                           p->pos++;
                                                                                                                                                                           /* [] -> lista vacía (no hay espacio entre corchetes) */
                                                                                                                                                                           if (p->pos < p->len && p->input[p->pos] == ']') {
                                                                                                                                                                               p->pos++;
                                                                                                                                                                       ...
                                                                                                                                                                       if (c == '-' || (c >= '0' && c <= '9')) {
                                                                                                                                                                           ...
                                                                                                                                                                           /* Decidir si es flotante mirando si hay '.' o 'e'/'E' antes de
                                                                                                                                                                           ...
                                                                                                                                                                           if (ival < INT_MIN || ival > INT_MAX) {
                                                                                                                                                                               /* No cabe en int: intentar como flotante. */
                                                                                                                                                                               errno = 0;
                                                                                                                                                                               double fval = strtod(start, &end);
                                                                                                                                                                               if (errno == ERANGE || end == start)
                                                                                                                                                                       ...
                                                                                                                                                                       /* Cualquier otra cosa (incluido '$', '!', identificadores desnudos)
                                                                                                                                                                        * no es válida como valor: el archivo es solo datos. */
                                                                                                                                                                   ...
                                                                                                                                                                   static Value deserialize_value_binary(const unsigned char *buffer, size_t *offset,
                                                                                                                                                                       ...
                                                                                                                                                                       return val_make_null();
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         static Value builtin_tofile(int argc, Value *args) {
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             const char *path = args[1].data.sval;

                                                                                                                                                                                                             /* Validar que el destino no sea un directorio ni un archivo especial.
                                                                                                                                                                                                              * stat() devuelve 0 si la ruta existe; -1 si no existe (caso normal y
                                                                                                                                                                                                              * deseado al crear un archivo nuevo). Si existe, solo permitimos
                                                                                                                                                                                                              * archivos regulares, para no intentar escribir sobre directorios,
                                                                                                                                                                                                              * FIFOs, sockets, dispositivos, etc., donde el rename() atómico
                                                                                                                                                                                                              * posterior fallaría o produciría efectos indeseados. */
                                                                                                                                                                                                             struct stat st;
                                                                                                                                                                                                             if (stat(path, &st) == 0) {
                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                 if (!S_ISREG(st.st_mode)) {
                                                                                                                                                                                                                     error(current_eval_line,
                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                           "(modo 0%o)", path, (unsigned)(st.st_mode & 07777));
                                                                                                                                                                                                                 }
                                                                                                                                                                                                             } else if (errno != ENOENT) {
                                                                                                                                                                                                                 /* stat() falló por algo que no es "no existe": permisos, ruta
                                                                                                                                                                                                                  * con un componente no-directorio, symlink roto con ELOOP, etc.
                                                                                                                                                                                                                  * Preferimos abortar con un mensaje claro antes de que mkstemp
                                                                                                                                                                                                                  * genere un error críptico. */
                                                                                                                                                                                                                 error(current_eval_line,
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             /* Añadir salto de línea final POSIX. */
                                                                                                                                                                                                             char *with_nl = realloc(text, data_len + 2);
                                                                                                                                                                                                             if (!with_nl) {
                                                                                                                                                                                                                 free(text);
                                                                                                                                                                                                                 error(current_eval_line, "Memoria insuficiente");
                                                                                                                                                                                                             }
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             write_file_atomic(path, with_nl, data_len + 1);
                                                                                                                                                                                                             free(with_nl);
                                                                                                                                                                                                             return val_make_null();
                                                                                                                                                                                                         }
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         static Value builtin_frombinfile(int argc, Value *args) {
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             if (version != DB_BINARY_VERSION) {
                                                                                                                                                                                                                 free(data);
                                                                                                                                                                                                                 error(current_eval_line, "Versión de formato binario no soportada: %u", version);
                                                                                                                                                                                                             }
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         static Value builtin_deletefile(int argc, Value *args) {
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             return val_bool(unlink(args[0].data.sval) == 0);
                                                                                                                                                                                                         }
